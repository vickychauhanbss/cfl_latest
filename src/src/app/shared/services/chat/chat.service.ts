...
import { bloackRequest } from '../../../interfaces/block'
...
export class ChatService {
	...
	login(params: AuthRequest): Observable<Auth> {
		console.log(params)
		return this.http.post(`${this.BASE_URL}login`, params, this.httpOptions).pipe(
			map(
				(response: Auth) => {
					return response;
				},
	...
	Clear_Chat(params: MessageRequest): Observable<MessagesResponse> {
		return this.http.post(`${this.BASE_URL}clearChat`, JSON.stringify(params), this.httpOptions).pipe(
			map(
				(response: MessagesResponse) => {
				console.log(response);
	...
	block_user_from_chat(params: bloackRequest): Observable<MessagesResponse> {
		return this.http.post(`${this.BASE_URL}blockUser`, JSON.stringify(params), this.httpOptions).pipe(
			map(
				(response: MessagesResponse) => {
				console.log(response);
	...
	unblock_user_from_chat(params: bloackRequest): Observable<MessagesResponse> {
		return this.http.post(`${this.BASE_URL}unblockUser`, JSON.stringify(params), this.httpOptions).pipe(
			map(
				(response: MessagesResponse) => {
				console.log(response);
